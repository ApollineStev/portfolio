    ...
    <div>
      ...
      <section id="competences">
        ...
        <div id="compbar">
          ...
          <div className="cv">
             <img src={require('./img/cv capture.png')} alt="cv"></img>
             <a className="down-cv" target="_blank" href={require('./img/CV-webdev-junior.pdf')} rel="noreferrer" download>
              <p>télécharger cv</p>
             </a>
        </div>
        </div>
      ...
      <div className="contactlink">
        ...
        <div>
          ...
          <div>
              <a href="https://www.linkedin.com/in/stevenin-apolline-b48893246/" target="_blank" rel="noreferrer"><img src={require('./img/whiteLinkedin.png')} alt="linkedin logo"></img></a>
              <a href="https://github.com/ApollineStev" target="_blank" rel="noreferrer"><img src={require('./img/whiteGithub.png')} alt="github logo" /></a>
          </div>
        </div>
      </div>
